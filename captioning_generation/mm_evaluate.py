...
import string
import sys
sys.path.insert(0, './cococaption') # Hack to allow the import of pycocoeval
...
if __name__=='__main__':
    ...
    parser.add_argument('-s', '--submission', type=str,  default='../data/mm_ours_proposal.json',
    ...
    parser.add_argument('-ppv', '--max-proposals-per-video', type=int, default=10,
