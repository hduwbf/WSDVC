...
def video_post_process(opt, video_list, video_dict):
    for video_name in video_list:
        # df = pd.read_csv("./output/event_results/" + video_name + ".csv")
        # df = pd.read_csv("./output/action_results/" + video_name + ".csv")
        # df = pd.read_csv("./output/activity_results/" + video_name + ".csv")
        # df = pd.read_csv("./output/highlight_results/" + video_name + ".csv")
        # df = pd.read_csv("./output/full_results/" + video_name + ".csv")
        # df = pd.read_csv("./output/student_results/" + video_name + ".csv")
        df = pd.read_csv("./output/ws_results/" + video_name + ".csv")
...
def BMN_post_processing(opt):
    ...
    # outfile = open('./output/action_proposal.json', "w")
    # outfile = open('./output/event_proposal.json', "w")
    # outfile = open('./output/activity_proposal.json', 'w')
    # outfile = open('./output/highlight_proposal.json', 'w')
    # outfile = open('./output/full_proposal.json', 'w')
    # outfile = open('./output/student_proposal.json', 'w')
    outfile = open('./output/ws_proposal.json', 'w')
...
def random_post_processing(opt):
    ...
    for video_name in video_list:
        result = []
        duration = video_dict[video_name]['duration_second']
        for i in range(100):
            anno = {}
