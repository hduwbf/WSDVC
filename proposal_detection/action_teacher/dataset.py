...
class VideoDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == "train":
            match_score_start, match_score_end, confidence_score = self._get_train_label(index, self.anchor_xmin, self.anchor_xmax)
...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(
        VideoDataSet(opt, subset="train"),batch_size=opt["batch_size"], 
